...
1. "regular" logger. prints to time rotating file (10 second
...
'''
1st logger = 
 - prints to an appended sample.log, does not 
 - prints to console
 - does not rotate sample.log

 Handler2 = with different formatter
'''
file_name = 'logger1.log'
